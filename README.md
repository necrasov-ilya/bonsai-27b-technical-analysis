...
## Примечание
Этот документ был подготовлен GPT5.6 Sol по акцентным моментам, которые, опять же, я упростил в рамках поста, постарался полностью проверить корректность всего тут написанного перечитав этот текст несколько раз - спасибо!